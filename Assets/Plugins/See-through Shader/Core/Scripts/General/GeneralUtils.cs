...
public static readonly Dictionary<string, string> STS_BIRP_SHADER_DICTIONARY = new Dictionary<string, string>
{
    ...
    {
#if UNITY_2021
        //{ "HDRP/Unlit", "SeeThroughShader/URP/2021/Lit" },
        { "HDRP/Lit", "SeeThroughShader/URP/2021/Lit" },
        { SeeThroughShaderConstants.STS_SHADER_DEFAULT_KEY, "SeeThroughShader/URP/2021/Lit" },
#elif UNITY_2020
        //{ "HDRP/Unlit", "SeeThroughShader/URP/2020/Lit" },
        { "HDRP/Lit", "SeeThroughShader/URP/2020/Lit" },
        { SeeThroughShaderConstants.STS_SHADER_DEFAULT_KEY, "SeeThroughShader/URP/2020/Lit" },
#elif UNITY_2019
        //{ "HDRP/Unlit", "SeeThroughShader/URP/2019/Lit" },
        { "HDRP/Lit", "SeeThroughShader/URP/2019/Lit" },
        ...
        private static List<string> getNamesOfAllChangedPropertyValues(Material instancedMaterial, Material referenceMaterial)
        {
            if (instancedMaterial != null && referenceMaterial != null)
            {
                ...
                if (GeneralUtils.STS_SHADER_LIST.Contains(instancedMaterial.shader.name) &&
                    GeneralUtils.STS_SHADER_LIST.Contains(referenceMaterial.shader.name))
                {
