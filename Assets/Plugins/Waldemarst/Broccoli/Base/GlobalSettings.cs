...
namespace Broccoli.Base
{
	public static class GlobalSettings
	{
		...
		/// <summary>
		/// Experimental flag to use the native graph view for editors.
		/// </summary>
		public static bool experimentalGraphViewCanvas = true;
		#endregion
		...
		/// </summary>
		public static bool sproutLabDebugEnabled = false;
		#endregion
