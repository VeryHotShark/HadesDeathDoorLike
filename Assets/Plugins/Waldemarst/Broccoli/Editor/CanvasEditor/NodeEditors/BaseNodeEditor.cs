...
namespace Broccoli.TreeNodeEditor
{
	...
	public abstract class BaseNodeEditor : Editor {
		...
		public override void OnInspectorGUI () {
			showNodeDescription = BroccoEditorGUI.DrawHeader (baseNode.nodeName, baseNode.nodeDescription, baseNode.nodeHelpURL, baseNode.headerColor, showNodeDescription);
