...
namespace NodeCanvas.Tasks.Actions
{
    ...
    public class GetActionInputValue : NodeCanvas.Framework.ActionTask
    {
        ...
        void OnActionPerformed(InputAction.CallbackContext context) { saveValueAs.value = context.ReadValueAsObject(); }
        void OnActionCanceled(InputAction.CallbackContext context) { saveValueAs.value = context.ReadValueAsObject(); }
