...
namespace KinematicCharacterController.Walkthrough.NoClipState
{
    ...
    public class MyCharacterController : MonoBehaviour, ICharacterController
    {
        ...
        [FormerlySerializedAs("NoClipMoveSpeed")] [Header("NoClip")]
        public float _noClipMoveSpeed = 10f;
        [FormerlySerializedAs("NoClipSharpness")] public float _noClipSharpness = 15;
