...
namespace KinematicCharacterController.Walkthrough.CollisionFiltering
{
    ...
    public class MyCharacterController : MonoBehaviour, ICharacterController
    {
        ...
        [FormerlySerializedAs("OrientTowardsGravity")] public bool _orientTowardsGravity = true;
        [FormerlySerializedAs("MeshRoot")] public Transform _meshRoot;
        [FormerlySerializedAs("IgnoredColliders")] public List<Collider> _ignoredColliders = new List<Collider>();
