...
namespace VHS {
    public class Player : Actor<Player> {
        ...
        public Action<PlayerSkill> OnSkillCooldownStart = delegate {  };
        public Action<PlayerSkill> OnSkillCooldownUpdate = delegate {  };
        public Action<PlayerSkill> OnSkillCooldownEnd = delegate {  };
